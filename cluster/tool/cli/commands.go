...
type (
	...
	// ReadResourceCommand is the command line data structure for the read action of resource
	ReadResourceCommand struct {
...

{
   "data": [
      {
         "id": "Sed aperiam voluptatum.",
         "type": "identities"
      }
   ],
   "included": [
      "e2c38a5c-85ba-4f06-ad7a-79c299a27a6f",
      "e2c38a5c-85ba-4f06-ad7a-79c299a27a6f"
   ]
}`,
...

{
   "data": [
	...
	tmp5 := new(AuthorizeAuthorizeCommand)
	sub = &cobra.Command{
	...
	tmp6 := new(CallbackAuthorizeCommand)
	sub = &cobra.Command{
	...
	tmp8 := new(CreateOrganizationCommand)
	sub = &cobra.Command{
...
{
   "name": "Pariatur itaque excepturi."
}`,
...

{
   "data": {
      "attributes": {
         "approved": true,
         "bio": "Ut odit vel esse.",
         "cluster": "Et atque omnis magnam placeat.",
         "company": "Sed qui inventore ad inventore at omnis.",
         "contextInformation": {
            "last_visited_url": "https://a.openshift.io",
            "space": "3d6dab8d-f204-42e8-ab29-cdb1c93130ad"
         },
         "email": "Commodi voluptatem alias dolore est.",
         "emailVerified": false,
         "enabled": false,
         "featureLevel": "Sit doloremque dolorem ad qui est.",
         "fullName": "Eaque et.",
         "imageURL": "Commodi architecto velit dolorem distinctio.",
         "providerType": "Laborum quam.",
         "registrationCompleted": true,
         "rhd_user_id": "Sapiente est sed accusamus temporibus.",
         "rhd_username": "Autem rerum.",
         "url": "Commodi fugit et voluptas.",
         "username": "Necessitatibus ipsam illum ut repellendus velit."
      },
      "links": {
         "meta": {
            "Vero qui voluptatibus illum natus dignissimos.": "84fa59de-b73a-44f0-9826-d630f912676c"
         },
         "related": "Et et qui maiores.",
         "self": "Voluptatem impedit rem eligendi consectetur."
      },
      "type": "Rem error."
   }
}`,
	...
	tmp12 := new(CreateInviteInvitationCommand)
	sub = &cobra.Command{
...

{
   "data": [
	...
	tmp13 := new(DeleteResourceCommand)
	sub = &cobra.Command{
	...
	tmp16 := new(DeprovisionNamedusersCommand)
	sub = &cobra.Command{
	...
	tmp17 := new(ExchangeTokenCommand)
	sub = &cobra.Command{
		Use:   `token ["/api/token"]`,
		Short: ``,
		Long: `
...
{
   "client_id": "Incidunt ratione sit.",
   "client_secret": "Facilis neque eum aut in amet est.",
   "code": "Cumque sit earum delectus.",
   "grant_type": "authorization_code",
   "redirect_uri": "Non ut nihil esse voluptatibus.",
   "refresh_token": "Laudantium recusandae et voluptatum architecto reiciendis fugiat."
}`,
	...
	tmp18 := new(GenerateTokenCommand)
	sub = &cobra.Command{
	...
	tmp21 := new(ListCollaboratorsCommand)
	sub = &cobra.Command{
		Use:   `collaborators ["/api/spaces/SPACEID/collaborators"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp22 := new(ListOrganizationCommand)
	sub = &cobra.Command{
		Use:   `organization ["/api/organizations"]`,
		Short: ``,
	...
	tmp26 := new(ListAssignedResourceRolesCommand)
	sub = &cobra.Command{
		Use:   `resource-roles ["/api/resources/RESOURCEID/roles"]`,
		Short: ``,
	...
	tmp27 := new(ListAssignedByRoleNameResourceRolesCommand)
	sub = &cobra.Command{
	...
	tmp28 := new(ListTeamsSpaceCommand)
	sub = &cobra.Command{
...
{
   "refresh_token": "Et sit earum rerum voluptates vitae accusantium."
}`,
	...
	tmp33 := new(RegisterResourceCommand)
	sub = &cobra.Command{
...
{
   "parent_resource_id": "Atque sint ea laborum.",
   "resource_id": "Animi et iure fugit vitae totam.",
   "type": "Dignissimos distinctio eum est corrupti non maiores."
}`,
	...
	tmp34 := new(RemoveCollaboratorsCommand)
	sub = &cobra.Command{
		Use:   `collaborators ["/api/spaces/SPACEID/collaborators/IDENTITYID"]`,
		Short: ``,
	...
	tmp35 := new(RemoveManyCollaboratorsCommand)
	sub = &cobra.Command{
		Use:   `collaborators ["/api/spaces/SPACEID/collaborators"]`,
		Short: ``,
		Long: `
...

{
   ...
   "included": [
	...
	tmp36 := new(RescindInviteInvitationCommand)
	sub = &cobra.Command{
		Use:   `invitation ["/api/invitations/INVITETO"]`,
		Short: ``,
	...
	tmp37 := new(RetrieveTokenCommand)
	sub = &cobra.Command{
		Use:   `token ["/api/token"]`,
		Short: ``,
	...
	tmp38 := new(SendEmailVerificationCodeUsersCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp40 := new(ShowOpenidConfigurationCommand)
	sub = &cobra.Command{
...

{
   "data": {
      "attributes": {
         ...
         "email": "Sint optio.",
         "emailPrivate": false,
         "featureLevel": "Minima officiis.",
         "fullName": "Aut itaque a consequatur eos nisi et.",
         "imageURL": "Nihil repellat voluptatem eos quidem voluptatem.",
         "registrationCompleted": true,
         "url": "Quos iure qui laudantium.",
         "username": "Deleniti voluptatibus quam repellat tenetur explicabo velit."
      },
      "links": {
         "meta": {
            "Vero qui voluptatibus illum natus dignissimos.": "84fa59de-b73a-44f0-9826-d630f912676c"
	...
	tmp48 := new(VerifyEmailUsersCommand)
	sub = &cobra.Command{
...
func (cmd *AuthorizeAuthorizeCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
func (cmd *AuthorizeAuthorizeCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
...
func (cmd *CallbackAuthorizeCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *CallbackAuthorizeCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var code string
...
func (cmd *ShowClustersCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *ShowClustersCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
}

// Run makes the HTTP request corresponding to the AddCollaboratorsCommand command.
func (cmd *AddCollaboratorsCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *AddCollaboratorsCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
...
func (cmd *AddManyCollaboratorsCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	var payload client.AddManyCollaboratorsPayload
	if cmd.Payload != "" {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *AddManyCollaboratorsCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
...
func (cmd *ListCollaboratorsCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *ListCollaboratorsCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var spaceID string
	cc.Flags().StringVar(&cmd.SpaceID, "spaceID", spaceID, `ID of the space`)
	var pageLimit int
...
func (cmd *RemoveCollaboratorsCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *RemoveCollaboratorsCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var identityID string
	cc.Flags().StringVar(&cmd.IdentityID, "identityID", identityID, ``)
	var spaceID string
	cc.Flags().StringVar(&cmd.SpaceID, "spaceID", spaceID, `ID of the space`)
...
func (cmd *RemoveManyCollaboratorsCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	var payload client.RemoveManyCollaboratorsPayload
	if cmd.Payload != "" {
		err := json.Unmarshal([]byte(cmd.Payload), &payload)
		if err != nil {
			return fmt.Errorf("failed to deserialize payload: %s", err)
...
// RegisterFlags registers the command flags with the command line.
func (cmd *RemoveManyCollaboratorsCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	cc.Flags().StringVar(&cmd.Payload, "payload", "", "Request body encoded in JSON")
	cc.Flags().StringVar(&cmd.ContentType, "content", "", "Request content type override, e.g. 'application/x-www-form-urlencoded'")
	var spaceID string
	cc.Flags().StringVar(&cmd.SpaceID, "spaceID", spaceID, `ID of the space`)
...
func (cmd *AcceptInviteInvitationCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *AcceptInviteInvitationCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
...
func (cmd *CreateInviteInvitationCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	var payload client.CreateInviteInvitationPayload
	if cmd.Payload != "" {
		err := json.Unmarshal([]byte(cmd.Payload), &payload)
		if err != nil {
			return fmt.Errorf("failed to deserialize payload: %s", err)
...
// RegisterFlags registers the command flags with the command line.
func (cmd *CreateInviteInvitationCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	cc.Flags().StringVar(&cmd.Payload, "payload", "", "Request body encoded in JSON")
	cc.Flags().StringVar(&cmd.ContentType, "content", "", "Request content type override, e.g. 'application/x-www-form-urlencoded'")
	var inviteTo string
...
func (cmd *RescindInviteInvitationCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *RescindInviteInvitationCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var inviteTo string
...
func (cmd *LogoutLogoutCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *LogoutLogoutCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var redirect string
...
func (cmd *DeprovisionNamedusersCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *DeprovisionNamedusersCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var username string
...
func (cmd *ShowOpenidConfigurationCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *ShowOpenidConfigurationCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
}

// Run makes the HTTP request corresponding to the CreateOrganizationCommand command.
func (cmd *CreateOrganizationCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	var payload client.CreateOrganizationPayload
	if cmd.Payload != "" {
		err := json.Unmarshal([]byte(cmd.Payload), &payload)
		if err != nil {
			return fmt.Errorf("failed to deserialize payload: %s", err)
...
// RegisterFlags registers the command flags with the command line.
func (cmd *CreateOrganizationCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	cc.Flags().StringVar(&cmd.Payload, "payload", "", "Request body encoded in JSON")
	cc.Flags().StringVar(&cmd.ContentType, "content", "", "Request content type override, e.g. 'application/x-www-form-urlencoded'")
}

// Run makes the HTTP request corresponding to the ListOrganizationCommand command.
func (cmd *ListOrganizationCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *ListOrganizationCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
}

// Run makes the HTTP request corresponding to the DeleteResourceCommand command.
func (cmd *DeleteResourceCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *DeleteResourceCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var resourceID string
	cc.Flags().StringVar(&cmd.ResourceID, "resourceId", resourceID, `Identifier of the resource to delete`)
}

// Run makes the HTTP request corresponding to the ReadResourceCommand command.
func (cmd *ReadResourceCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.ReadResource(ctx, path)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *ReadResourceCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var resourceID string
...
func (cmd *RegisterResourceCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	var payload client.RegisterResourcePayload
	if cmd.Payload != "" {
		err := json.Unmarshal([]byte(cmd.Payload), &payload)
		if err != nil {
			return fmt.Errorf("failed to deserialize payload: %s", err)
...
// RegisterFlags registers the command flags with the command line.
func (cmd *RegisterResourceCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	cc.Flags().StringVar(&cmd.Payload, "payload", "", "Request body encoded in JSON")
	cc.Flags().StringVar(&cmd.ContentType, "content", "", "Request content type override, e.g. 'application/x-www-form-urlencoded'")
}

// Run makes the HTTP request corresponding to the AssignRoleResourceRolesCommand command.
func (cmd *AssignRoleResourceRolesCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	var payload client.AssignRoleResourceRolesPayload
	if cmd.Payload != "" {
		err := json.Unmarshal([]byte(cmd.Payload), &payload)
		if err != nil {
			return fmt.Errorf("failed to deserialize payload: %s", err)
...
// RegisterFlags registers the command flags with the command line.
func (cmd *AssignRoleResourceRolesCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	cc.Flags().StringVar(&cmd.Payload, "payload", "", "Request body encoded in JSON")
	cc.Flags().StringVar(&cmd.ContentType, "content", "", "Request content type override, e.g. 'application/x-www-form-urlencoded'")
	var resourceID string
...
func (cmd *ListAssignedResourceRolesCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *ListAssignedResourceRolesCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var resourceID string
	cc.Flags().StringVar(&cmd.ResourceID, "resourceID", resourceID, ``)
}

// Run makes the HTTP request corresponding to the ListAssignedByRoleNameResourceRolesCommand command.
func (cmd *ListAssignedByRoleNameResourceRolesCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *ListAssignedByRoleNameResourceRolesCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var resourceID string
	cc.Flags().StringVar(&cmd.ResourceID, "resourceID", resourceID, ``)
	var roleName string
...
func (cmd *UsersSearchCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *UsersSearchCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var pageLimit int
	cc.Flags().IntVar(&cmd.PageLimit, "page[limit]", pageLimit, `Paging size`)
	var pageOffset string
	cc.Flags().StringVar(&cmd.PageOffset, "page[offset]", pageOffset, `Paging start position`)
...
func (cmd *CreateSpaceCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *CreateSpaceCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var spaceID string
	cc.Flags().StringVar(&cmd.SpaceID, "spaceID", spaceID, `ID of the space`)
}

// Run makes the HTTP request corresponding to the DeleteSpaceCommand command.
func (cmd *DeleteSpaceCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *DeleteSpaceCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var spaceID string
	cc.Flags().StringVar(&cmd.SpaceID, "spaceID", spaceID, `ID of the space`)
}

// Run makes the HTTP request corresponding to the ListTeamsSpaceCommand command.
func (cmd *ListTeamsSpaceCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *ListTeamsSpaceCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var spaceID string
	cc.Flags().StringVar(&cmd.SpaceID, "spaceID", spaceID, `ID of the space`)
}
...
func (cmd *CreateTeamCommand) Run(c *client.Client, args []string) error {
	...
	var payload client.CreateTeamPayload
	if cmd.Payload != "" {
		err := json.Unmarshal([]byte(cmd.Payload), &payload)
		if err != nil {
			return fmt.Errorf("failed to deserialize payload: %s", err)
...
func (cmd *DeleteTokenCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *DeleteTokenCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var for_ string
...
func (cmd *ExchangeTokenCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	var payload client.TokenExchange
	if cmd.Payload != "" {
		err := json.Unmarshal([]byte(cmd.Payload), &payload)
		if err != nil {
			return fmt.Errorf("failed to deserialize payload: %s", err)
...
// RegisterFlags registers the command flags with the command line.
func (cmd *ExchangeTokenCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	cc.Flags().StringVar(&cmd.Payload, "payload", "", "Request body encoded in JSON")
	cc.Flags().StringVar(&cmd.ContentType, "content", "", "Request content type override, e.g. 'application/x-www-form-urlencoded'")
}

// Run makes the HTTP request corresponding to the RetrieveTokenCommand command.
func (cmd *RetrieveTokenCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	if cmd.ForcePull != "" {
		var err error
		tmp49, err = boolVal(cmd.ForcePull)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--force_pull", "err", err)
			return err
		}
	}
	resp, err := c.RetrieveToken(ctx, path, cmd.For, tmp49)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *RetrieveTokenCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var for_ string
...
func (cmd *StatusTokenCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	if cmd.ForcePull != "" {
		var err error
		tmp50, err = boolVal(cmd.ForcePull)
		if err != nil {
			goa.LogError(ctx, "failed to parse flag into *bool value", "flag", "--force_pull", "err", err)
			return err
		}
	}
	resp, err := c.StatusToken(ctx, path, cmd.For, tmp50)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *StatusTokenCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var for_ string
...
func (cmd *CallbackTokenCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *CallbackTokenCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var code string
...
func (cmd *GenerateTokenCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *GenerateTokenCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
}

// Run makes the HTTP request corresponding to the KeysTokenCommand command.
func (cmd *KeysTokenCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *KeysTokenCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var format string
...
func (cmd *LinkTokenCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *LinkTokenCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var for_ string
...
func (cmd *RefreshTokenCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	var payload client.RefreshToken
	if cmd.Payload != "" {
		err := json.Unmarshal([]byte(cmd.Payload), &payload)
		if err != nil {
			return fmt.Errorf("failed to deserialize payload: %s", err)
...
// RegisterFlags registers the command flags with the command line.
func (cmd *RefreshTokenCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	cc.Flags().StringVar(&cmd.Payload, "payload", "", "Request body encoded in JSON")
	cc.Flags().StringVar(&cmd.ContentType, "content", "", "Request content type override, e.g. 'application/x-www-form-urlencoded'")
}
...
func (cmd *ShowUserinfoCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *ShowUserinfoCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
}
...
func (cmd *SendEmailVerificationCodeUsersCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *SendEmailVerificationCodeUsersCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
}
...
func (cmd *VerifyEmailUsersCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
...
// RegisterFlags registers the command flags with the command line.
func (cmd *VerifyEmailUsersCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var code string
