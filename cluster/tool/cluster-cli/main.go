...
import (
	"fmt"
	"github.com/fabric8-services/fabric8-cluster-client/cluster/client"
	"github.com/fabric8-services/fabric8-cluster-client/cluster/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "cluster-cli",
		Short: `CLI client for the cluster service`,
	}
